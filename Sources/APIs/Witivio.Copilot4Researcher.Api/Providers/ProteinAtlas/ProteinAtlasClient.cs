...
namespace Witivio.Copilot4Researcher.Providers.ProteinAtlas
{
    ...
    {
        Task<Gene> SearchAsync(GeneSearchQuery query);
    }
    ...
    public class ProteinAtlasClient : IProteinAtlasClient
    {
        ...
        public async Task<Gene> SearchAsync(GeneSearchQuery query)
        {
            ...
            var gene = new Gene
            {
                ...
                Expressions = result.Entry.TissueExpression.Images.Select(p => new Witivio.Copilot4Researcher.Models.TissueExpression
                {
                    Organ = p.Tissue.Name,
                    ImageUrl = p.ImageUrl
                }).ToList()
