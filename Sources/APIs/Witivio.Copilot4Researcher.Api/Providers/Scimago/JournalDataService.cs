namespace Witivio.Copilot4Researcher.Providers.Scimago
{
    ...
    public class JournalDataService : IJournalDataService
    {
        ...
        {
            var path = Path.Combine(Environment.CurrentDirectory, "providers/scimago/data");
        ...
        public async Task<JournalData> SearchByTitleAsync(string title)
        {
            ...
            return await Task.FromResult(_data.FirstOrDefault(j => j.Title.Equals(title, StringComparison.OrdinalIgnoreCase)));
        }
    }
