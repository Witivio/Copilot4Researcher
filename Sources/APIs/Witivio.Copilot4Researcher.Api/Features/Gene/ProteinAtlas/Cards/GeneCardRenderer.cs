...
namespace Witivio.Copilot4Researcher.Features.Gene.ProteinAtlas.Cards
{
    public class GeneCardRenderer
    {
        public static AdaptiveCard Render(Witivio.Copilot4Researcher.Features.Gene.Models.Gene gene)
        {
